...
void Task1code(void *parameter) {
  ...
  while(true){
      ...
      if(axesSet==false)
      {
        ...
        if(axesSet==false)
        {
          if (difference>30  && zGesamt > xGesamt)
          {
            ...
            rechtsLinksAchseString = "xGesamt";
            axesSet = true;
          }
          else if(difference>30  && zGesamt < xGesamt)
          {
            vorneHintenAchseString = "xGesamt";
      ...
      Serial.print("Die Achse die für Vorne und Hinten zuständig ist: ");
      Serial.println(vorneHintenAchseString.c_str());

      Serial.print("Die Achse die für Rechts und Links zuständig ist: ");
      Serial.println(rechtsLinksAchseString.c_str());
